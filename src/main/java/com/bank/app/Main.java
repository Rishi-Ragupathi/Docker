...
import com.bank.model.PremiumAccount;
...
/**
 * Main class to run the Bank Account application.
 */
public class Main {
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      System.out.println("Final Balance: "
              + service.getById(created.getId()).getBalance());
      System.out.println("-------------------------------------");
  ...
  private static void printAccount(BankAccount acc) {
    ...
    System.out.println("Aadhaar Number : "
            + acc.getCustomer().getAadhaarNumber());
  ...
  /**
   * Creates a saving account with customer and address.
   */
  private static SavingAccount getSavingAccount(
